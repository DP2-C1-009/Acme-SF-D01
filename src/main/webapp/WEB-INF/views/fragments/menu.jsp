...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		<acme:menu-option code="master.menu.anonymous" access="isAnonymous()">
			...
			<acme:menu-suboption code="master.menu.anonymous.favourite-link-riccarmar" action="https://www.marca.com/"/>
		...
		<acme:menu-option code="master.menu.auditor" access="hasRole('Auditor')">
			<acme:menu-suboption code="master.menu.auditor.my-code-audits" action="/auditor/codeaudit/list"/>
		</acme:menu-option>
	</acme:menu-left>
